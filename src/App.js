...
function App() {
  ...
  return (
      ...
      </path><path fill="#FABB05" d="M8.85 27.77c-.4-1.19-.62-2.46-.62-3.77s.22-2.58.62-3.77v-5.2h-6.7C.78 17.73 0 20.77 0 24s.78 6.27 2.14 8.97l6.71-5.2z"></path>
      <path fill="#E94235" d="M20 12c2.93 0 5.55 1.01 7.62 2.98l5.76-5.76C29.92 5.98 25.39 4 20 4 12.18 4 5.43 8.49 2.14 15.03l6.7 5.2C10.41 15.51 14.81 12 20 12z"></path></svg>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input 
            ...
            required 
            value={email} 
            onChange={(e) => setEmail(e.tatget.value)}/>
          ...
          <input 
            ...
            required 
            value={password} 
            onChange={(e) => setPassword(e.tatget.value)}/>
